...
- **Hosted follow-up on direct-DNS head `a077f16`:** [all five CI jobs](https://github.com/rndaom/execs/actions/runs/35940690985) and the [Linux native rerun](https://github.com/rndaom/execs/actions/runs/35940690981) passed. The [Linux package rerun](https://github.com/rndaom/execs/actions/runs/35940690993) failed at the candidate GTK Import chooser after previous-public export and candidate launch/read; the exact ZIP path was visible but the dialog stayed mapped after one Return. A guarded, import-only harness retry passes 22 focused local tests but needs a hosted rerun. The [Windows capability rerun](https://github.com/rndaom/execs/actions/runs/35940690983) repeated the earlier listener/identity failure. None of these results close D7/D8 or the release matrix.

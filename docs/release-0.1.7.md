...
Status: implementation and qualification in progress. Publication is not
...
- [ ] Actual public 0.1.6 export/import and exact-byte round trip
- [ ] Supported window sizes, zoom, keyboard, screen readers and IME
- [ ] Novice and experienced Files workflows
- [ ] Lock, external conflict, failed write and transition regressions
...
- [ ] Four version files, Cargo lockfile and 0.1.7 changelog agree

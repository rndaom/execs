...
| [RND-251](https://linear.app/rndaom/issue/RND-251/run-the-cumulative-windows-and-linux-functional-release-matrix-before) | In Progress | Windows/Linux automated CI passed; native and package matrix open | /root | Five-job CI and four actual 0.1.8 library fixtures passed; native/package/release rows open |
...
| [RND-215](https://linear.app/rndaom/issue/RND-215/enforce-one-hud-per-profile-across-replacement-import-switch-and) | In Progress | HUD ownership and exact-byte boundaries implemented; Windows and Linux fixtures passed | /root/foundry_hud | 69 frontend, Windows/Linux CI workspace and separate corpus pass; native pending |
...
**Remaining implementation/qualification:** Native Windows/Linux runtime, packaged startup and updater/profile compatibility, actual Cloud and approved TF2/Casual/performance matrix. Four actual public-v0.1.8 export/import fixtures pass at the Windows core-library level; this does not close packaged migration acceptance. Draft PR #60 CI passes at 542b3dd20f2847fc90a1a4e990584f03830fcc6d.
...
**Remaining implementation/qualification:** Native Windows/Linux dialogs/close and realistic prior-profile packaged compatibility. No real player library was deleted.

...
The app also talks to GameBanana, teamfortress.tv, Dropbox and Imgur to resolve
HUD downloads and author albums linked from hud-db, and reads download and view

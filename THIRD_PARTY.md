...
The [D7 asset-rights register](docs/audits/2026-09-23-program-audit/d7-asset-rights.md) records the pinned files, local installation uses and unresolved permission evidence for CompVMInstaller, Venom Crosshairs and TF2Hitsounds. It does not treat repository visibility or attribution as a grant.

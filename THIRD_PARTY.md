...
| [Developer Textures Overhaul v2](https://gamebanana.com/mods/336110) by FPS_Engineer, with earlier VMT work credited to ayrtonSilna | The original author 7z is fetched directly from GameBanana for this saved Casual choice. Its complete archive, contained VPK and exact 996-file game tree are pinned before local packing; Developer-only Apply and switch do not require cueki's library. Profile ZIPs carry the selection without the author archive or generated preload pack. | The [current author checklist](https://gamebanana.com/apiv11/Mod/336110/LicensePage) allows direct download/install and asks before redistribution or modified/partial distribution. The [author page](https://gamebanana.com/apiv11/Mod/336110/ProfilePage) credits both contributors; exact source bytes do not establish every underlying right or generic custom-pack sharing permission. See the D7 register. |

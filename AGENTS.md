...
## 0.1.7 Hotfix 1 Files usability

- The owner assigns the Files pane usability rebuild to `0.1.7+1`, displayed as 0.1.7 Hotfix 1. It starts from the public 0.1.7 maintenance baseline and does not change cfg ownership, save, draft, analysis or write-lock behavior.
